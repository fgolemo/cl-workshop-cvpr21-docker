...
### FOR PERFORMANCE REASONS, THE SEQUOIA IMPORTS ARE BELOW
...
run_sl = partial(run_track, ClassIncrementalSetting, "sl_track.yaml")
run_rl = partial(run_track, IncrementalRLSetting, "rl_track.yaml")
