...
_GREETER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Shutdown',
    full_name='helloworld.Greeter.Shutdown',
    index=2,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_EMPTY,
